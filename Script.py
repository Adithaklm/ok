...
• /broadcast - <code>to broadcast a message to all users</code>"""
    STATUS_TXT = """<b>╭─[ ᴄɪɴᴇᴍᴀ ᴄᴏᴍᴘᴀɴʏ sᴛᴀᴛᴜs ]──〄
│
...
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href=https://t.me/my_devs>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
    ...
    COMP_TXT = """ Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴀʟʟ ᴛʜᴇ ɴᴇᴡ ᴀɴᴅ ᴏʟᴅ ᴍᴏᴠɪᴇs ᴀɴᴅ ᴡᴇʙsᴇʀɪᴇs, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʟɪɴᴋ ʙᴇʟᴏᴡ ᴀɴᴅ ᴊᴏɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ᴀɴᴅ ʀᴇǫᴜᴇsᴛ

പുതിയതും പഴയതുമായ എല്ലാ മൂവികളും വെബ് സീരീയസുകളും  വേണമെങ്കിൽ താഴെ കാണുന്ന ലിങ്കിൽ ക്ലിക്ക് ചെയ്ത് ഗ്രൂപ്പിൽ ജോയിൻ ചെയ്ത ശേഷം റിക്വസ്റ്റ്  ചെയുക

★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ᴄɪɴɪᴍᴀʟᴏᴋʜᴀᴍ"""
    LOG_TEXT_P = """#NewUser
ID - <code>{}</code>
Name - {}
"""
